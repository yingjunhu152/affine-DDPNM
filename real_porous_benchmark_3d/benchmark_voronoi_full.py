#!/usr/bin/env python3
"""Complete 100-sphere Voronoi benchmark — error table + cost table + contour plots."""
...
OUT = PROJ / "outputs" / "benchmark_voronoi_100"
OUT.mkdir(parents=True, exist_ok=True)

# ── 1. Partition ──
print("=== 100-sphere Voronoi benchmark ===")
...
report={
    "partition":"voronoi","mesh_cells":int(nc),"n_interfaces":int(ni),"n_regions":int(nr),
...
print("="*120)
print(f"\nporosity={por:.1%} | r_max-r_min={SPHERES[:,3].max()-SPHERES[:,3].min():.4f} | standard Voronoi")

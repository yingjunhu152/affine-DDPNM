...
Heterogeneous-100 and per-interface normal-flux fields
($q=\mathbf{u}\cdot\mathbf{n}$) for the interface-structure
visualization; (f)~an independent second porous configuration at a
...
Fig.~\ref{fig:fields} was regenerated from the field archives
\texttt{affine\_benchmark\_fields.npz} and
\texttt{random\_benchmark\_fields.npz}.  No unreported experiment was

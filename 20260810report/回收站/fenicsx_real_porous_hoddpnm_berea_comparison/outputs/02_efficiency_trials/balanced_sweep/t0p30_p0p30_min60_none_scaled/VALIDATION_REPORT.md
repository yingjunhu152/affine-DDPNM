...
|---|---:|---|
| gmres_iterations | 3.950000e+02 | GMRES callback iterations for the matrix-free Schur solve |
| gmres_relative_residual | 1.690594e-06 | relative residual of the reported Schur solve |
| active_boundary_dofs | 4.650000e+02 | free active Schur boundary unknown count after removing known Dirichlet/gauge dofs |
| known_fixed_dofs | 2.194000e+04 | known Dirichlet/gauge dofs removed before forming the active Schur unknown set |
| eliminated_interior_dofs | 2.012700e+04 | interior unknown count eliminated by local Schur reconstruction |
| velocity_l2_rel | 5.708683e-07 | FEM mass-matrix integral relative L2 error for P2 velocity |
| velocity_h1_seminorm_rel | 6.135163e-07 | FEM stiffness-matrix relative H1 seminorm error for P2 velocity |
| pressure_l2_rel | 1.421541e-14 | FEM mass-matrix integral relative L2 error for pinned-gauge P1 pressure |
| pressure_l2_mean_aligned_rel | 1.248409e-14 | FEM mass-matrix pressure L2 error after removing the mass-weighted mean pressure shift |
| pressure_eliminated_dofs | 2.044000e+03 | P1 pressure unknown count eliminated inside subregions |
...
| permeability_like_rel_error | 5.383708e-08 | relative difference in proxy effective-permeability quantity Q L / (A delta-p) |
| hoddpnm_continuity_row_residual_l2 | 1.297458e-09 | L2 norm of mixed-system pressure-row residual for HODDPNM solution |

"""Run the six random-27 FEM/DDPNM/Affine frozen/SFI experiments."""

from __future__ import annotations

import os

# Gmsh/LLVM and SciPy/MKL load different OpenMP runtimes on the Windows
# FEniCSx environment.  This must be set before NumPy, SciPy or gmsh imports.
...
from schbench.experiment import run_random27
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", type=Path, default=Path("outputs") / "random27_rewrite")
